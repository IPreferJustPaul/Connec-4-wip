...
int queen_move(int board[10][10], int move1, int x, int y, int turn) {
	...
	if (board[9 - a][b] == 176 + turn * 2 || board[9 - a][b] == 91 + turn * 2) {
		...
		board[9 - x][y] = 32;
		system("cls");
		if (((board[10 - c][d + 1] == 176 + turn * 2 || board[10 - c][d + 1] == 91 + turn * 2) && board[11 - c][d + 2] == 32) || ((board[10 - c][d - 1] == 176 + turn * 2 || board[10 - c][d - 1] == 91 + turn * 2) && board[11 - c][d - 2] == 32) || ((board[10 - c][d + 1] == 176 + turn * 2 || board[10 - c][d + 1] == 91 + turn * 2) && board[11 - c][d + 2] == 32) || ((board[10 - c][d - 1] == 176 + turn * 2 || board[10 - c][d - 1] == 91 + turn * 2) && board[11 - c][d - 2] == 32)) {
			return 1;
		}
		return 0;
	}
...
int white_move(int board[10][10], int move1, int x, int y, int turn) {
	...
	if (board[9 - a][b] == 176 + turn * 2 || board[9 - a][b] == 91 + turn * 2) {
		...
		board[9 - x][y] = 32;
		system("cls");
		if (((board[8 - c][d + 1] == 176 + turn * 2 || board[8 - c][d + 1] == 91 + turn * 2) && board[7 - c][d + 2] == 32) || ((board[8 - c][d - 1] == 176 + turn * 2 || board[8 - c][d - 1] == 91 + turn * 2) && board[7 - c][d - 2] == 32)) {
			return 1;
		}
		return 0;
	}
...
int black_move(int board[10][10], int move1, int x, int y, int turn) {
	...
	if (board[9 - a][b] == 176 + turn * 2 || board[9 - a][b] == 91 + turn * 2) {
		...
		if (move3 > 50 || move3<1 || c == a || c>x + 2 || c < x - 2 || board[9 - c][d] != 32) {
			system("cls");
			printf("Nope! Try again.\n");
			if (board[10 - c][d+1] == 176 + turn * 2 || board[10 - c][d + 1] == 91 + turn * 2 || board[10 - c][d - 1] == 176 + turn * 2 || board[10 - c][d - 1] == 91 + turn * 2) {
				return 1;
			}
			return 0;
		}
		...
		board[9 - x][y] = 32;
		system("cls");
		if (((board[10 - c][d + 1] == 176 + turn * 2 || board[10 - c][d + 1] == 91 + turn * 2) && board[11 - c][d + 2] == 32) || ((board[10 - c][d - 1] == 176 + turn * 2 || board[10 - c][d - 1] == 91 + turn * 2) && board[11 - c][d - 2] == 32)) {
			return 1;
		}
		return 0;
	}
...
int move(int board[10][10], int turn, int backup[10][10]) {
	int move1, x, y, fail, i, j;
	turn++;
	turn = turn % 2;
...
int main(int argc, char* argv[]) {
	int board[10][10], turn = 1, backup[10][10];
	char response=65;
	while (1 < 2) {
		reset_board(board);
		while (1 < 2) {
			turn = move(board, turn, backup);
			if (turn == 69) {
